...
$worksheet = session.spreadsheet_by_key("1raMYBKs5Y3UUaAQ1dQVYidaeWEhcUbzPMEdSnvEulcs").worksheets[0]
...
def get_all_the_urls_of_val_de_marne_townhalls (url)
	...
	page.css(".lientxt").each do |town|
		...
		url = "http://annuaire-des-mairies.com/94/#{town_name}.html"
...
get_all_the_urls_of_val_de_marne_townhalls("http://annuaire-des-mairies.com/val-de-marne.html")